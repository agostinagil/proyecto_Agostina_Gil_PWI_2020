...
const adminProdsRouter = require('./routes/admin/productos');
const adminUsersRouter = require('./routes/admin/usuarios');
...
//ADMIN
app.use('/admin/productos', adminProdsRouter);
app.use('/admin/usuarios', adminUsersRouter);
